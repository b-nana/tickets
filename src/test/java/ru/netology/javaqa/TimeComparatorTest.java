...
public class TimeComparatorTest {
    ...
    public void shouldSearchAndSortCorrectly() {
        ...
        Ticket ticket3 = new Ticket(3, 8_000, "DME", "LED", 35);
        Ticket ticket4 = new Ticket(4, 7_000, "DME", "LED", 30);
        ...
        Ticket[] actual = manager.findAll("DME", "LED", timeComparator);
    ...
    public void shouldSearchAndSortIfEquals() {
        ...
        Ticket ticket1 = new Ticket(1, 10_000, "DME", "EGO", 120);
        Ticket ticket2 = new Ticket(2, 15_000, "OGZ", "LED", 180);
        Ticket ticket3 = new Ticket(3, 7_000, "DME", "LED", 35);
